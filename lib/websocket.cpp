...
const QString QWsSocket::regExpExtensionsStr( QLatin1String("\r\nSec-WebSocket-Extensions:\\s(.+)\r\n") );
		...
		switch ( _version )
		{
			...
			case WS_V13:
			{
				...
				else
				{
					...
					body.append( QWsSocket::serializeInt( (int)closeStatusCode, 2 ) );
...
void QWsSocket::processHandshake()
{
	...
	regExp.setPattern(QWsSocket::regExpExtensionsStr);
	regExp.indexIn(handshakeResponse);
	...
	QString accept = QWsSocket::computeAcceptV4(key);
...
QByteArray QWsSocket::serializeInt( quint32 number, quint8 nbBytes)
{
	QByteArray ba;
...
QString QWsSocket::computeAcceptV4(QString key)
{
...
QString QWsSocket::generateNonce()
{
